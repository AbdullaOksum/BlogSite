        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostedTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ParetCommentId = table.Column<int>(type: "int", nullable: true),
                    BlogId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Comments_Comments_ParetCommentId",
                        column: x => x.ParetCommentId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryBlogs_CategoryId_BlogId",
                table: "CategoryBlogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_ParetCommentId",
                table: "Comments",
                column: "ParetCommentId");
        }
